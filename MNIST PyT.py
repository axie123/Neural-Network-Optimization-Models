...
def train(epoch):
    ...
    for batch_idx, (data, target) in enumerate(train_loader):
        ...
        if batch_idx % log_interval == 0:
            ...
            th.save(network.state_dict(), r'C:\Users\Andy Xie\Documents\Work\Research\Aspuru Guzik Group\MNIST Neural Networks\Databases\model2.pth')
            th.save(optimizer.state_dict(), r'C:\Users\Andy Xie\Documents\Work\Research\Aspuru Guzik Group\MNIST Neural Networks\Databases\optimizer2.pth') #Unicode error: \U is a 8-char unicode escape. If followed by 's', it will be invalid.
...
optimizer_state_dict = th.load(r'C:\Users\Andy Xie\Documents\Work\Research\Vector Institute 2018-2019\optimizer.pth')
